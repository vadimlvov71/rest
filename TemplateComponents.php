...
use app\components\TranslitComponents;
 
class TemplateComponents extends Component{
	...
	<div class="col-sm-3">
		<a href="<?php echo($path."/".$href)?><?php //echo($item["cat_translit"])?>/<?php //echo($item["goods_translit"]."_".$item["id"])?>">
			<div class="article-section marginSection shadow">	
				<div class="hotelHeader"><?php echo($item["name"])?></div>
				<div class="img1">
					<img align="center"  class="hotel_image img-fluid-height" src="<?php echo($imagePath)?>/<?php echo($item["smallfoto"])?>" alt="">
				</div>
				<div class="hotelHeader">Подробно</div>
